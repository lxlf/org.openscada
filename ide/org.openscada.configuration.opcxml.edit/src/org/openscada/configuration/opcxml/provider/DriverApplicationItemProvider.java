...
/**
 * This is the item provider adapter for a {@link org.openscada.configuration.opcxml.DriverApplication} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
        ...
        IItemPropertySource
{
    ...
    protected void addDevicesPropertyDescriptor(Object object)
    {
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_DriverApplication_devices_feature"), //$NON-NLS-1$
                 getString("_UI_PropertyDescriptor_description", "_UI_DriverApplication_devices_feature", "_UI_DriverApplication_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                 OpcxmlPackage.Literals.DRIVER_APPLICATION__DEVICES,
                 true,
                 false,
                 true,
                 null,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
    {
        if (childrenFeatures == null)
        {
            ...
            childrenFeatures.add(OpcxmlPackage.Literals.DRIVER_APPLICATION__DEVICES);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
    {
        ...
        newChildDescriptors.add
            (createChildParameter
                (OsgiPackage.Literals.EQUINOX_APPLICATION__CONNECTIONS,
                 OsgiFactory.eINSTANCE.createSfpDataAccessConnection()));
        ...
        newChildDescriptors.add
            (createChildParameter
                (OsgiPackage.Literals.EQUINOX_APPLICATION__MODULES,
                 OsgiFactory.eINSTANCE.createEventInjectorManager()));

        newChildDescriptors.add
            (createChildParameter
                (OpcxmlPackage.Literals.DRIVER_APPLICATION__DEVICES,
                 OpcxmlFactory.eINSTANCE.createHiveDevice()));
    }
