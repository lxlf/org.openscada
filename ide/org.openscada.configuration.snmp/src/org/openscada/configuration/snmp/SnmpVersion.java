 ...
 * <!-- end-user-doc -->
 * @see org.openscada.configuration.snmp.SnmpPackage#getSnmpVersion()
 * @model
 * @generated
 */
public enum SnmpVersion implements Enumerator
{
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>V3</b></em>' literal object isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * @see #V3
     ...
     * @generated
     */
    private static final SnmpVersion[] VALUES_ARRAY =
        new SnmpVersion[]
        {
            V1,
            V2,
     ...
     * @generated
     */
    public static final List<SnmpVersion> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
