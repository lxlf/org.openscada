 ...
 *******************************************************************************/
package org.openscada.configuration.iec60870.lib;
...
{
    private static final String BUNDLE_IEC60870_EXPORTER = "org.openscada.da.server.exporter.iec60870"; //$NON-NLS-1$

    private static final String DEVICE_FACTORY_ID = "org.openscada.da.server.exporter.iec60870.device"; //$NON-NLS-1$
    ...
    public void process ( final OscarContext ctx, final EquinoxApplication application, final IProgressMonitor monitor )
    {
        try
        {
            Helper.ensureOpenScadaDependency ( application );
