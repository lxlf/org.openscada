...
public class PDU implements BERSerializable, Serializable {
   ...
   * @since 2.2.4
   */
  public void addAll(List<VariableBinding> vbs) {
  ...
  /**
   * Computes the length in bytes of the BER encodedvariable bindings without
   * including the length of BER sequence length.
   * @param variableBindings
   *    a list of variable bindings.
   */
  public static int getBERLength(List<VariableBinding> variableBindings) {
    int length = 0;
    // length for all vbs
